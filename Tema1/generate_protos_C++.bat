...
set GRPC_PATH=D:\Vcpkg\vcpkg-master\vcpkg-master\installed\x86-windows\tools\grpc
set PROTOC_PATH=D:\Vcpkg\vcpkg-master\vcpkg-master\installed\x86-windows\tools\protobuf
